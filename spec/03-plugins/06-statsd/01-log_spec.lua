  ...
  describe("Plugin: statsd (log) [#" .. strategy .. "]", function()
    ...
    describe("metrics #grpc", function()
      it("logs over UDP with default metrics", function()
        ...
        assert.contains("kong.service.grpc_statsd1.request.status.200:1|c", metrics)
        assert.contains("kong.service.grpc_statsd1.request.status.total:1|c", metrics)
  ...
  describe("Plugin: statsd (log) [#" .. strategy .. "]", function()
    ...
    describe("configures globally", function()
      it("sends default metrics with global.matched namespace", function()
        local metrics_count = 8 -- 6 less than normal
        ...
        assert.contains("kong.global.unmatched.request.status.404:1|c", metrics)
        ...
        assert.not_contains("kong.global.unmatched.user.robert.status.404:1|c",
          metrics)
        assert.not_contains("kong.global.unmatched.workspace." .. uuid_pattern .. ".request.status.200:1|c",
          metrics, true)
